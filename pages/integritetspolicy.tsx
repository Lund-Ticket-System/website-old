      ...
      <Layout>
        ...
        <Box>
          <Container maxW="container.md" py="1rem" fontSize="lg">
            <Text>
              Privacy Policy for Lunds Akademiska Biljettbyrå (LABB). At LABB,
              we are committed to protecting the privacy of our users. The
              Privacy Policy describes how we collect, use, and share
              information about you when you use our website and mobile
              application.
              ...
              <VStack mt="1rem" spacing="1rem" alignItems="left">
                <Text>
                  We collect information when you use our services. This
                  includes:
                </Text>
                <Text>
                ...
                <Text>
                  ...
                  our services, such as the pages you visit and the features you
                  use. We may also collect information about your device, such
                  as your device type, operating system, and what browser you
                  are using.
                </Text>
                <Text>
                  Location Information: If granted permission, we may collect
                  your device&apos;s location information to provide you with
              ...
              <VStack mt="1rem" spacing="1rem" alignItems="left">
                ...
                <Text>
                  ...
                  marketing campaigns, improving the user experience and
                  locating app crashes.
                </Text>
              </VStack>
              <Heading as="h2" fontSize="2xl" mt="2rem">
              ...
              <VStack mt="1rem" spacing="1rem">
                <Text>
                  ...
                  However, we may share your information with third party
                  vendors for various purposes, such as:
                </Text>
                <Text>
                  Service Providers: We may share your information with
                  third-party service providers who help us provide and improve
                  our services, such as payment processors and marketing
                  partners.
                </Text>
                <Text>
                ...
                <Text>
                  ...
                  necessary to comply with law or to protect the rights,
              ...
              <Box mt="1rem">
                <Text>
                  ...
                  information from unauthorized access, use, and disclosure. We
                  do not store passwords, we use one time passwords instead.
                </Text>
                <Text>
              ...
              <Box mt="1rem">
                <Text>
                  ...
                  you by email or by posting a notice on our website or mobile
                  application.
                </Text>
              </Box>
              <Heading as="h2" fontSize="2xl" mt="2rem">
